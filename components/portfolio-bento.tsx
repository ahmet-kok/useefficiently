  ...
  return (
    <figure
      className={cn(
        ...
        // dark styles
        "transform-gpu dark:bg-transparent dark:backdrop-blur-md dark:[border:1px_solid_rgba(255,255,255,.1)] border dark:border-none  dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]"
      )}
    >

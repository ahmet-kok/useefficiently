...
function Badge({ className, variant, ...props }: BadgeProps) {
  return (
    <h4 className={cn(badgeVariants({ variant }), className)} {...props} />
  );
}

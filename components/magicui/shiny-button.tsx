...
const ShinyButton = ({
  ...
  return (
    <motion.button
      ...
      {...animationProps}
      className={cn(
        "mx-auto relative rounded-lg w-full min-w-auto px-3 py-3 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow text-nowrap",
    ...
    >
      ...
      <span
        className={cn(
          "relative block h-full w-full text-md tracking-wide",
